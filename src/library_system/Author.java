...
public class Author extends javax.swing.JFrame {
    ...
    private void authorTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_authorTableMouseClicked
        // TODO add your handling code here:
        DefaultTableModel d2 = (DefaultTableModel)authorTable.getModel();
        int selectIndex = authorTable.getSelectedRow();
        
        //GET BY ID
        int id = Integer.parseInt(d2.getValueAt(selectIndex,0).toString());
        txtFirstName.setText(d2.getValueAt(selectIndex,1).toString());
        txtLastName.setText(d2.getValueAt(selectIndex,2).toString());
        txtAddress.setText(d2.getValueAt(selectIndex,3).toString());
        txtPhone.setText(d2.getValueAt(selectIndex,4).toString());
